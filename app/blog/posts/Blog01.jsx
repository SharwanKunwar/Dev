...
export default function Blog01() {
  ...
  return ( 
    ...
    >
      ...
      <button onClick={()=>setLearnMore(!learnMore)} className='mastShadow py-1 px-6 border border-black/30 hover:border-white/30 hover:bg-blue-300 hover:rounded mb-10 dark:border-white/30 dark:text-gray-50 hover:dark:text-black'>Learn More</button>
      {
        learnMore && (
          <>
           {/* Git Section */}
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 mt-2 text-gray-800 dark:text-gray-200">
                <li>
                  <strong>Version control</strong> : <span className='text-neutral-500 dark:text-gray-300'>Go back to working code when things break.</span>
                </li>
                <li>
                  <strong>Collaboration</strong> : <span className='text-neutral-500 dark:text-gray-300'>Work with other developers on the same project — from anywhere!</span>
                </li>
                <li>
                  <strong>Experiment safely</strong> : <span className='text-neutral-500 dark:text-gray-300'> Use branches to test ideas without affecting main code.</span>
                </li>
                <li>
                  <strong>History tracking</strong> : <span className='text-neutral-500 dark:text-gray-300'> Know who made what change and when.</span>
                </li>
                <li>
                  <strong>Open-source sharing</strong> : <span className='text-neutral-500 dark:text-gray-300'> Contribute to global software projects.</span>
                </li>
              </ul>
            </div>
